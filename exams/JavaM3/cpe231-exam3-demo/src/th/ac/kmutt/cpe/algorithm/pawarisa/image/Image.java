package th.ac.kmutt.cpe.algorithm.pawarisa.image;
...
public class Image {
    ...
    public void export(String fileName){
        ...
        try {
            ...
            String yourName = "pawarisa";
            ImageIO.write(img, "png", new File("src/th/ac/kmutt/cpe/algorithm/"+yourName+"/image/"+fileName));    
        } catch (IOException e) {
            e.printStackTrace();
        }
